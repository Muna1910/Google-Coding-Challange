...
class VideoPlayer:
    ...
    def __init__(self):
        self._video_library = VideoLibrary()  # information about the videos
        self.video_under_process = video_under_process()  # plays current video
    ...
    def play_random_video(self):
        ...
        videos = random.choice(self._video_library.get_all_videos())
        self.play_video(videos._video_id)
    ...
    def show_all_playlists(self):
        ...
        if (len(self.playlists.keys()) == 0):  #  no playlist added
    ...
    def flag_video(self, video_id, flag_reason=""):
        ...
        if video != None:
            if (video.flagged == None):
                ...
                # if it is the same video that is playing then stop it
                if (self.video_under_process.video != None):
